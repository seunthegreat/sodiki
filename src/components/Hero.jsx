    ...
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2'>
        <p className={`${styles.paragraph} ml-2 text-[14px]`}>
          <span className='text-white'>All Investments Strategies</span>
          <span className='text-white'>  {" "}</span>
          <span className='text-white'>{""}</span>and Investments  Involve loss
        </p>
      </div>
      ...
      <h1 className="font-poppins font-normal ss:[text-68px] text-[52px] text-white ss:leading-[70px] leading-[75px] w-full">
